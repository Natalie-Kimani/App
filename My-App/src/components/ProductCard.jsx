  ...
  if (isEditing) {
    return (
      <div style={styles.card}>
        ...
        <input style={styles.input} value={editOrigin} onChange={e => setEditOrigin(e.target.value)} />

        <select style={styles.input} value={editRoast} onChange={e => setEditRoast(e.target.value)}>
